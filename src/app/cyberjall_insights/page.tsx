  ...
  const features = [
    {
      ...
      description:
        "Real-world incidents and success stories from your industry",
      details: [
        "Real incidents, real results",
        "Filter by industry, business size, or attack type",
      ],
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="fixed inset-0 opacity-30">
        ...
        <div
          className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-gradient-to-r from-red-400/10 to-orange-400/10 rounded-full blur-3xl animate-bounce"
      ...
      <section className="relative z-10 pt-20 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              Stay ahead of evolving threats, compliance changes, and innovation
              with our exclusive business-focused intelligence hub —
              <span className="text-orange-400 font-semibold">
                {" "}
                Free for All CyberJall Clients
              </span>
            </p>
        ...
        <div className="max-w-6xl mx-auto mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`text-center p-6 bg-gradient-to-br from-red-900/20 to-orange-900/20 rounded-2xl backdrop-blur-sm border border-red-500/20 hover:border-orange-500/40 transition-all duration-500 hover:scale-105 transform ${
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
              }`}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Your personalized cybersecurity knowledge companion — a premium
              intelligence suite built to help your business stay secure,
            ...
            {[
              {
                ...
                description:
                  "Trusted source of business-focused cybersecurity knowledge in one place",
                color: "from-red-500 to-orange-500",
              },
              {
                icon: TrendingUp,
                ...
                description:
                  "Helps you reduce risk, meet compliance, and make informed decisions",
                color: "from-orange-500 to-red-600",
              },
              {
                icon: Zap,
                ...
                description:
                  "Built exclusively for businesses using CyberJall — completely free",
                color: "from-red-600 to-orange-400",
              },
            ].map((benefit, index) => (
              <div
              ...
              >
                <div
                  className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${benefit.color} mb-6 group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="p-12 bg-gradient-to-br from-red-900/30 to-orange-900/30 rounded-3xl border border-red-500/30 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link
                  href={"/contact_us"}
                  className="group relative px-12 py-6 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl font-bold text-xl hover:from-red-500 hover:to-orange-500 transform hover:scale-105 transition-all duration-300 shadow-2xl shadow-red-500/25"
                >
                  <span className="relative z-10 flex items-center gap-3">
              ...
              <div className="mt-8 flex items-center justify-center gap-3 text-gray-400">
                ...
                <span className="font-semibold">
                  Included FREE with all CyberJall packages
                </span>
              </div>
            </div>
          </div>
      ...
      <footer className="relative z-10 py-12 px-6 border-t border-red-500/20">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400">
            Empowering businesses with premium cybersecurity intelligence — Free
            for all CyberJall clients.
          </p>
        </div>
      </footer>
    </div>
