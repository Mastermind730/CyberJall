...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      <Head>
        <title>Network Penetration Testing | CyberJall</title>
        <meta name="description" content="Professional Network Penetration Testing Services" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <header className="py-6 flex justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold text-white">CyberJall</span>
            </div>
            <nav className="hidden md:flex space-x-8">
              <a href="#methodology" className="text-gray-300 hover:text-white transition-colors">Methodology</a>
              <a href="#expertise" className="text-gray-300 hover:text-white transition-colors">Expertise</a>
              <a href="#packages" className="text-gray-300 hover:text-white transition-colors">Packages</a>
              <a href="#faq" className="text-gray-300 hover:text-white transition-colors">FAQ</a>
            </nav>
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-red-600 hover:bg-red-700 py-2 px-6 rounded-full text-white font-medium transition-colors duration-300"
            >
              Contact Us
            </motion.button>
          </header>
      ...
      {/* Packages Section */}
      <section id="packages" className="py-20 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Flexible <span className="text-red-600">Testing Packages</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Choose the right level of testing for your organization's needs
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {packages.map((pkg, index) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                whileHover={{ scale: 1.03 }}
                className={`bg-gradient-to-br ${pkg.recommended ? 'from-red-900/40 to-red-950/40 border-red-700' : 'from-gray-900 to-gray-800 border-gray-800'} p-8 rounded-xl border-2 relative transition-all duration-300`}
              >
                {pkg.recommended && (
                ...
                <p className="text-3xl font-bold mb-6 text-red-500">{pkg.price}</p>
                ...
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className={`w-full py-3 px-6 rounded-lg ${pkg.recommended ? 'bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600' : 'bg-gray-800 hover:bg-gray-700'} text-white font-medium transition-colors duration-300`}
                >
                  Select Package
                </motion.button>
              </motion.div>
        ...
        <footer className="py-12 bg-black border-t border-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500">
              <p>&copy; {new Date().getFullYear()} CyberJall. All rights reserved.</p>
            </div>
          </div>
        </footer>
