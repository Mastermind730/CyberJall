          ...
          <svg width="404" height="404" fill="none" viewBox="0 0 404 404">
            <defs>
              <pattern id="pattern-circles" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                <circle cx="10" cy="10" r="2" className="text-red-800" fill="currentColor" />
              </pattern>
            </defs>
          ...
          <svg width="404" height="404" fill="none" viewBox="0 0 404 404">
            <defs>
              <pattern id="pattern-squares" x="0" y="0" width="30" height="30" patternUnits="userSpaceOnUse">
                <rect x="10" y="10" width="10" height="10" className="text-orange-500" fill="currentColor" />
              </pattern>
            </defs>
        ...
        <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="max-w-xl mx-auto text-xl text-gray-400">
              We're proud to collaborate with these amazing organizations to deliver excellence.
            </p>
                      ...
                      <div>
                        <div className="flex justify-center mb-4 h-32 items-center">
                          {partner.logo && partner.logo !== "" ? (
                            ...
                            <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${getRandomColor(partner.id)} flex items-center justify-center text-white text-2xl font-bold shadow-lg`}>
          ...
          <div className="absolute top-1/4 left-5 animate-pulse">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="rgba(239, 68, 68, 0.3)" strokeWidth="2">
              <circle cx="12" cy="12" r="10" />
            </svg>
          </div>
          <div className="absolute bottom-1/4 right-5 animate-bounce">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="rgba(249, 115, 22, 0.3)" strokeWidth="2">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
            </svg>
          </div>
          <div className="absolute top-1/2 right-1/4 animate-spin-slow">
            <svg width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="rgba(239, 68, 68, 0.2)" strokeWidth="2">
