...
const servicesData = [
  { id: 'api', name: 'API Security Testing', icon: 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8' },
  { id: 'cloud', name: 'Cloud Penetration Testing', icon: 'M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z' },
  { id: 'network', name: 'Network Penetration Testing', icon: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4' },
  { id: 'web', name: 'Web Penetration Testing', icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9' },
  { id: 'endpoint', name: 'Endpoint Security', icon: 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z' },
  { id: 'compliance', name: 'Compliance Audits', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
  { id: 'training', name: 'Security Training', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
  { id: 'others', name: 'Others', icon: 'M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z' }
];

const preferenceData = [
  { id: 'experience', name: 'Industry Experience', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  { id: 'pricing', name: 'Affordable Pricing', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  { id: 'response', name: 'Fast Response Time', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { id: 'track', name: 'Proven Track Record', icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z' },
  { id: 'flexible', name: 'Flexible Engagement Models', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { id: 'certifications', name: 'Certifications & Accreditations', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' }
];
...
const SvgIcon = (props:svgIconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={props.className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={props.path} />
  </svg>
);
...
//   }, []);
  ...
  const nextSection = async () => {
    ...
    switch (activeSection) {
      case 1:
        fieldsToValidate = ['companyName', 'industry', 'companySize', 'contactName', 'email'];
        break;
      case 2:
    ...
    type FormField = 'companyName' | 'industry' | 'companySize' | 'contactName' | 'email' | 'services' | 'providerPreferences' | 'multipleProviders' | 'packageDuration';
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Tell us what you're looking for, and we'll help connect you with the right cybersecurity service providers 
            — all in one custom package tailored to your needs.
          </p>
        </motion.div>
              ...
              {[1, 2, 3, 4, 5].map((step) => (
                <div key={step} className="flex flex-col items-center relative">
                  ...
                  <span className={`absolute -bottom-6 text-xs whitespace-nowrap ${
                    step === activeSection ? 'text-orange-400 font-medium' : 'text-gray-500'
                  }`}>
                    {['Business Info', 'Services', 'Preferences', 'Package', 'Submit'][step-1]}
                  </span>
                </div>
              ))}
              <div className="absolute top-4 h-px w-full bg-gray-700 -z-10" style={{ transform: 'translateY(-50%)' }}></div>
            </div>
          </motion.div>
        )}
              ...
              <div className="text-center relative z-10">
                ...
                >
                  <div className="p-4 rounded-xl bg-black/30 border border-gray-700">
                    <h3 className="text-xl font-semibold mb-2 text-gray-200">What&apos;s Next?</h3>
                    <p className="text-gray-300">
                      Our team at CyberJall is now reviewing your request. We&apos;ll coordinate with the most suitable service providers 
                      based on your preferences and package duration.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-black/30 border border-gray-700">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-200">Expected Response Time</h4>
                        <p className="text-gray-400">You can expect to hear from us within 1–2 business days with a curated proposal tailored to your needs.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-black/30 border border-gray-700">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-200">Questions?</h4>
                        <p className="text-gray-400">If you have any questions, feel free to reach out at <a href="mailto:support@cyberjall.com" className="text-orange-400 hover:text-orange-300 transition-colors">support@cyberjall.com</a></p>
                      </div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="relative overflow-hidden bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-black/90 p-8 md:p-10 rounded-2xl border border-gray-700/50 shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="flex items-center mb-8">
                      {renderSectionIcon(1)}
                      <h2 className="text-2xl md:text-3xl font-bold text-white ml-3">Business Information</h2>
                    </div>
                    ...
                    <motion.div variants={itemVariants} className="group">
                        ...
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <SvgIcon path="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" className="h-5 w-5 text-gray-500" />
                          </div>
                          <input
                            type="text"
                        ...
                        {errors.companyName && <p className="mt-2 text-red-400 text-sm">{errors.companyName.message}</p>}
                      </motion.div>
                      ...
                      <motion.div variants={itemVariants} className="group">
                        ...
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <SvgIcon path="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" className="h-5 w-5 text-gray-500" />
                          </div>
                          <select
                            {...register('industry')}
                          ...
                          <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <SvgIcon path="M19 9l-7 7-7-7" className="h-4 w-4 text-gray-500" />
                          </div>
                        </div>
                        {errors.industry && <p className="mt-2 text-red-400 text-sm">{errors.industry.message}</p>}
                      </motion.div>
                      
                      <motion.div variants={itemVariants} className="group">
                        <label className="block text-gray-300 mb-2 font-medium">Company Size</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <SvgIcon path="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" className="h-5 w-5 text-gray-500" />
                          </div>
                          <select
                        ...
                        {errors.companySize && <p className="mt-2 text-red-400 text-sm">{errors.companySize.message}</p>}
                      </motion.div>
                      
                      <motion.div variants={itemVariants} className="group">
                        <label className="block text-gray-300 mb-2 font-medium">Contact Person Name</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <SvgIcon path="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" className="h-5 w-5 text-gray-500" />
                          </div>
                          <input
                            type="text"
                        ...
                        {errors.contactName && <p className="mt-2 text-red-400 text-sm">{errors.contactName.message}</p>}
                      </motion.div>
                      ...
                      <motion.div variants={itemVariants} className="group">
                        ...
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <SvgIcon path="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" className="h-5 w-5 text-gray-500" />
                          </div>
                          <input
                            type="email"
                            {...register('email')}
              ...
              {activeSection === 2 && (
                ...
                >
                  <div className="bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-black/90 p-8 md:p-10 rounded-2xl border border-gray-700/50 shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="flex items-center mb-8">
                      {renderSectionIcon(2)}
                      <h2 className="text-2xl md:text-3xl font-bold text-white ml-3">Browse & Select Services</h2>
                    </div>
                    
                    <motion.div variants={itemVariants} className="mb-6">
                      <label className="block text-gray-300 mb-4 font-medium">What type of cybersecurity services are you interested in?</label>
                        ...
                        {servicesData.map((service) => (
                          ...
                          >
                            <input
                              ...
                              className="sr-only"
                            />
                            <label htmlFor={`service-${service.id}`} className="flex items-start cursor-pointer">
                              <div className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${
                                watchServices.includes(service.name) 
                                  ? 'bg-gradient-to-br from-red-600 to-orange-500' 
                                  : 'bg-gray-800'
                              }`}>
                                <SvgIcon path={service.icon} className="h-6 w-6 text-white" />
                              </div>
                              <div className="ml-3">
                                <div className="text-white font-medium">{service.name}</div>
                                {service.id === 'others' && watchServices.includes(service.name) && (
                                  <div className="mt-3">
                                    <input
                                      type="text"
                      ...
                      {errors.services && <p className="mt-3 text-red-400 text-sm">{errors.services.message}</p>}
                    </motion.div>
              ...
              {activeSection === 3 && (
                ...
                >
                  <div className="bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-black/90 p-8 md:p-10 rounded-2xl border border-gray-700/50 shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="flex items-center mb-8">
                      {renderSectionIcon(3)}
                      <h2 className="text-2xl md:text-3xl font-bold text-white ml-3">Provider Preferences</h2>
                    </div>
                    
                    <div className="space-y-8">
                      <motion.div variants={itemVariants}>
                        <label className="block text-gray-300 mb-4 font-medium">What do you value most in a service provider?</label>
                        <div className="grid md:grid-cols-2 gap-4">
                          {preferenceData.map((pref) => (
                            ...
                            >
                              <input
                                ...
                                className="sr-only"
                              />
                              <label htmlFor={`pref-${pref.id}`} className="flex items-start cursor-pointer">
                                <div className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${
                                  watchPreferences.includes(pref.name) 
                                    ? 'bg-gradient-to-br from-red-600 to-orange-500' 
                                    : 'bg-gray-800'
                                }`}>
                                  <SvgIcon path={pref.icon} className="h-6 w-6 text-white" />
                                </div>
                                <div className="ml-3">
                        ...
                        {errors.providerPreferences && <p className="mt-3 text-red-400 text-sm">{errors.providerPreferences.message}</p>}
                      </motion.div>
                      
                      <motion.div variants={itemVariants}>
                        <label className="block text-gray-300 mb-4 font-medium">Would you like to work with multiple providers in a single package?</label>
  ...
  onChange={() => setValue('multipleProviders', true)}
  className="sr-only"
/>
                            <label htmlFor="multiple-yes" className="flex items-center cursor-pointer">
  ...
  onChange={() => setValue('multipleProviders', false)}
  className="sr-only"
/>
                            <label htmlFor="multiple-no" className="flex items-center cursor-pointer">
                              <div className={`flex-shrink-0 w-6 h-6 rounded-full ${
                                watch('multipleProviders') === false 
                                  ? 'bg-orange-500 border-2 border-orange-300' 
                                  : 'border-2 border-gray-600'
              ...
              {activeSection === 4 && (
                ...
                >
                  <div className="bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-black/90 p-8 md:p-10 rounded-2xl border border-gray-700/50 shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="flex items-center mb-8">
                      {renderSectionIcon(4)}
                      <h2 className="text-2xl md:text-3xl font-bold text-white ml-3">Customize Your Package</h2>
                    </div>
                    
                    <div className="space-y-8">
                      <motion.div variants={itemVariants}>
                        <label className="block text-gray-300 mb-4 font-medium">Select Preferred Package Duration</label>
                          ...
                          {['4', '8', '12'].map((duration) => (
                            ...
                            >
                              <input
                                ...
                                className="sr-only"
                              />
                              <label htmlFor={`duration-${duration}`} className="block cursor-pointer">
                                <div className="text-2xl font-bold text-white mb-1">{duration}</div>
                        ...
                        {errors.packageDuration && <p className="mt-3 text-red-400 text-sm">{errors.packageDuration.message}</p>}
                      </motion.div>
                      
                      <motion.div variants={itemVariants}>
                        <label className="block text-gray-300 mb-2 font-medium">Add any special requirements or notes</label>
                        <div className="relative">
                          <div className="absolute top-3 left-3 flex items-start pointer-events-none">
                            <SvgIcon path="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" className="h-5 w-5 text-gray-500" />
                          </div>
                          <textarea
              ...
              {activeSection === 5 && (
                ...
                >
                  <div className="bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-black/90 p-8 md:p-10 rounded-2xl border border-gray-700/50 shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="flex items-center mb-8">
                      {renderSectionIcon(5)}
                      <h2 className="text-2xl md:text-3xl font-bold text-white ml-3">Review & Submit</h2>
                    </div>
                    
                    <div className="space-y-8">
                      <motion.div variants={itemVariants} className="bg-gray-900/50 rounded-xl p-6 border border-gray-700">
                        <h3 className="text-xl font-semibold mb-4 text-gray-200">Request Summary</h3>
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              <p className="text-gray-400">Company Name</p>
                              <p className="text-white">{watch('companyName')}</p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="text-white">{watch('companySize')}</p>
                            </div>
                            <div>
                              <p className="text-gray-400">Contact Person</p>
                              <p className="text-white">{watch('contactName')}</p>
                            </div>
                            <div>
                          ...
                          <div className="pt-4 border-t border-gray-700">
                            <p className="text-gray-400 mb-2">Selected Services</p>
                            <div className="flex flex-wrap gap-2">
                              {watch('services')?.map((service, index) => (
                                <span key={index} className="inline-flex items-center px-3 py-1 rounded-full bg-gray-800 text-sm text-white">
                                  {service}
                                </span>
                              ))}
                            </div>
                          ...
                          <div className="pt-4 border-t border-gray-700">
                            <p className="text-gray-400 mb-2">Provider Preferences</p>
                            <div className="flex flex-wrap gap-2">
                              {watch('providerPreferences')?.map((pref, index) => (
                                <span key={index} className="inline-flex items-center px-3 py-1 rounded-full bg-gray-800 text-sm text-white">
                                  {pref}
                                </span>
                              ))}
                          ...
                          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-700">
                            <div>
                              <p className="text-gray-400">Multiple Providers</p>
                              <p className="text-white">{watch('multipleProviders') ? 'Yes' : 'No'}</p>
                            </div>
                            <div>
                              <p className="text-gray-400">Package Duration</p>
                              <p className="text-white">{watch('packageDuration')} months</p>
                            </div>
                          </div>
                          
                          {watch('specialRequirements') && (
                            <div className="pt-4 border-t border-gray-700">
                              <p className="text-gray-400 mb-2">Special Requirements</p>
                              <p className="text-white">{watch('specialRequirements')}</p>
                            </div>
                          )}
                        </div>
                      </motion.div>
