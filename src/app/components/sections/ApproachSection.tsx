            ...
            {activeTab === "overview" && (
              <div className="space-y-6">
                ...
                <p className="text-gray-300 leading-relaxed text-lg max-w-3xl">
                  CyberJall revolutionizes digital protection by connecting
                  businesses with vetted experts through an intelligent
                  marketplace. Customize comprehensive security plans and stay
            ...
            {activeTab === "businesses" && (
              <div className="space-y-6 max-w-3xl">
                ...
                <p className="text-gray-300 leading-relaxed text-lg">
                  Find precisely tailored cybersecurity services from our
                  network of certified experts. Our marketplace eliminates the
                  complexity of securing your digital assets.
                </p>
            ...
            {activeTab === "providers" && (
              <div className="space-y-6 max-w-3xl">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-2xl font-semibold text-gray-100">
                    Amplify Your Security Expertise
                  </h2>
                </div>
                <p className="text-gray-300 leading-relaxed text-lg">
                  Showcase your capabilities to businesses seeking cybersecurity
                  solutions. Grow your practice through our trusted marketplace
                  platform.
                </p>
                <ul className="space-y-3 text-gray-300">
                  {[
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-16">
                  ...
                  <li key={index} className="flex items-start">
                    <span
                      className={`text-2xl mr-4 ${
                        index % 2 === 0 ? "text-orange-400" : "text-red-500"
                      }`}
                    >
                      ✓
                    </span>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/70 p-8 rounded-xl border-2 border-orange-500/30 flex flex-col justify-center backdrop-blur-sm">
              ...
              <p className="text-gray-300 text-center text-lg mb-6">
                One platform connecting businesses with the right security
                experts for their unique needs
              </p>
              ...
              {[
                {
                  ...
                  description:
                    "Explore cybersecurity solutions across all domains",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                  key={index}
                  className={`bg-gray-800/50 p-6 rounded-xl border-t-4 ${
                    step.border === "red"
                      ? "border-red-500"
                      : "border-orange-500"
                ...
                >
                  <div className="flex items-center mb-5">
                    <div
                      className={`${
                        step.border === "red" ? "bg-red-500" : "bg-orange-500"
                      } text-white font-bold rounded-full w-10 h-10 flex items-center justify-center mr-4`}
                    >
                      {index + 1}
                    </div>
                    <h4
